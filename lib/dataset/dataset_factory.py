...
# from lib.utils.augment import BaseTransform,SSDAugmentation
import torch.utils.data as data

# def load_data(cfg, phase):
#     if phase == 'train':
#         dataset = dataset_map[cfg.DATASET](cfg.DATASET_DIR, cfg.TRAIN_SETS, SSDAugmentation(cfg.IMAGE_SIZE[0], cfg.PIXEL_MEANS))
#         data_loader = data.DataLoader(dataset, cfg.TRAIN_BATCH_SIZE, num_workers=cfg.NUM_WORKERS,
#                                   shuffle=True, collate_fn=detection_collate, pin_memory=True)
#     if phase == 'eval':
#         dataset = dataset_map[cfg.DATASET](cfg.DATASET_DIR, cfg.TEST_SETS, BaseTransform(cfg.IMAGE_SIZE[0], cfg.PIXEL_MEANS))
